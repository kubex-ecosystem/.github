...
import { Loader, AlertTriangle, X, Wand2, Eye, Code, Share2, Clipboard, ClipboardCheck, BrainCircuit, Copy, Check } from 'lucide-react';
            ...
            return !inline && match ? (
                <div className="relative group my-4">
                    ...
                    <button
                        ...
                        className={`absolute top-2 right-2 p-1.5 rounded-md text-white opacity-0 group-hover:opacity-100 transition-all duration-200 ${
