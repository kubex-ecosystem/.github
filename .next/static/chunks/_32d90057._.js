...
function LanguageProvider({ children }) {
    ...
    const t = (key)=>{
        ...
        let value = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["translations"][language];
        for (const k of keys){
            value = value?.[k];
        }
        return value || key;
...
//# sourceMappingURL=_32d90057._.js.map